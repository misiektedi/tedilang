...
curl -s https://raw.githubusercontent.com/misiektedi/tedilang/main/bin/tedilang -o /tmp/tedilang
mv /tmp/tedilang $TEDILANG_INSTALL_PATH
chmod +x $TEDILANG_INSTALL_PATH
